...
function Clock() {
    ...
    function numToStr (value: number) {
        return value.toString().length === 1 ? `0${value}` : value
    }


    const stringTime = `${numToStr(date.getHours())}:${numToStr(date.getMinutes())}:${numToStr(date.getSeconds())}` || <br/> // часы24:минуты:секунды (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
    ...
    const stringDay = `${arrayOfDays[date.getDay()]}` || <br/> // пишут студенты
    const stringMonth = `${arrayOfMonths[date.getMonth()]}` || <br/> // пишут студенты
